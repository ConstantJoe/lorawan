                                       ...
                                       Ptr<EnergySource> source) const
{
  ...
  Ptr<EndDeviceLoraPhy> LoRaWANPhy = DynamicCast<EndDeviceLoraPhy> (LoRaWANDevice->GetPhy ());
  ...
  LoRaWANPhy -> TraceConnectWithoutContext ("EndDeviceState",MakeCallback(&LoRaWANRadioEnergyModel::ChangeLoRaWANState, model));
