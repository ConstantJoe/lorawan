...
LoRaWANRadioEnergyModel::LoRaWANRadioEnergyModel ()
{
  ...
  m_currentState = EndDeviceLoraPhy::State::SLEEP;  // initially LORAWAN_PHY_TRX_OFF; same as in lorawan-phy
  m_currentModel = NULL;
...
void
LoRaWANRadioEnergyModel::SetRxCurrentA (double oldBandwidth, double newBandwidth)
{
...
void
LoRaWANRadioEnergyModel::ChangeLoRaWANState (EndDeviceLoraPhy::State oldState, EndDeviceLoraPhy::State newState)
{
...
void
LoRaWANRadioEnergyModel::SetLoRaWANRadioState (const EndDeviceLoraPhy::State state)
{
