...
public:
  ...
  void SetRxCurrentA (double oldBandwidth, double newBandwidth);
   ...
   */
  EndDeviceLoraPhy::State GetCurrentState (void) const; //Note: type of this depends on LoRaWAN module used.
   ...
   */
  virtual void ChangeLoRaWANState (EndDeviceLoraPhy::State oldState, EndDeviceLoraPhy::State newState);
...
private:
   ...
   */
  void SetLoRaWANRadioState (const EndDeviceLoraPhy::State state);
